                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('examinations.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <x-input-label for="patient_id" :value="__('Pilih Pasien')" />
                            ...
                            <div>
                                ...
                                <x-text-input id="tanggal_pemeriksaan" class="block mt-1 w-full" type="date"
                                    name="tanggal_pemeriksaan" :value="old('tanggal_pemeriksaan', date('Y-m-d'))" required />
                                <x-input-error :messages="$errors->get('tanggal_pemeriksaan')" class="mt-2" />
                            </div>

                            <!-- Fields for both categories but with labels hint -->
                            <div>
                            ...
                            <div class="border-t pt-4 mt-2 md:col-span-2">
                                <h3 class="text-sm font-medium text-gray-700 mb-4">Data Khusus sesuai Kategori</h3>
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div>
                                                ...
                                                <x-text-input id="lila" class="block mt-1 w-full bg-white"
                                                    type="number" step="0.01" name="lila" :value="old('lila')" />
                                            </div>
                                            <div class="pt-2 border-t border-blue-200">
                                                <div class="flex items-center">
                                                    <input id="naik_berat_badan" type="checkbox" name="naik_berat_badan"
                                                        value="1" {{ old('naik_berat_badan') ? 'checked' : '' }}
                                            ...
                                            <div class="pt-2 border-t border-blue-200 space-y-3">
                                                <div>
                                                    ...
                                                    <select id="status_stunting" name="status_stunting"
                                                        ...
                                                        <option value="Normal"
                                                            {{ old('status_stunting') == 'Normal' ? 'selected' : '' }}>
                                                            Normal</option>
                                                        <option value="Stunted"
                                                            {{ old('status_stunting') == 'Stunted' ? 'selected' : '' }}>
                                                            Stunted (Pendek)</option>
                                                        <option value="Severely Stunted"
                                                            {{ old('status_stunting') == 'Severely Stunted' ? 'selected' : '' }}>
                                                ...
                                                <div>
                                                    ...
                                                    <x-text-input id="asupan_gizi"
                                                        ...
                                                        name="asupan_gizi" :value="old('asupan_gizi')"
                                                ...
                                                <div>
                                                    ...
                                                    <x-text-input id="imunisasi_gizi"
                                                        class="block mt-1 w-full bg-white text-sm" type="text"
                                                        name="imunisasi_gizi" :value="old('imunisasi_gizi')"
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div>
                                                ...
                                                <x-text-input id="djj" class="block mt-1 w-full bg-white"
                                                    type="number" name="djj" :value="old('djj')" />
                                            </div>
                                            <div class="pt-2 border-t border-pink-200">
                                                <div>
                                                    ...
                                                    <x-text-input id="tablet_fe" class="block mt-1 w-full bg-white"
                                                        type="number" name="tablet_fe" :value="old('tablet_fe', 0)" />
                                                </div>
                                                <div class="flex items-center mt-3">
                                                    <input id="is_kek" type="checkbox" name="is_kek"
                                                        value="1" {{ old('is_kek') ? 'checked' : '' }}
                            ...
                            <div class="md:col-span-2 mt-4">
                                ...
                                <textarea id="catatan" name="catatan" rows="3"
                                    class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('catatan') }}</textarea>
                            </div>
                        </div>
